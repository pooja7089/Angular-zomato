...
export class OrderService {
 public foundorder: { "orderId": string; "title": string; "description": string; "author": string; "body": string; "category": string; "tags": string[]; } | { "title": string; "description": string; "author": string; "body": string; "category": string; "tags": string[]; };
